...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<String> handleArgumentValidation(IllegalArgumentException e) {

        logger.error("An unrecognized error occurred.", e);

        return new ResponseEntity<>("An unrecognized error occurred.", HttpStatus.BAD_REQUEST);
    }
}
